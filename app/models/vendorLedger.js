...
paymentBank.hasMany(vendorLedger, {foreignKey:'creditId', onDelete:'CASCADE', as:'invoiceVendor'});
vendorLedger.belongsTo(paymentBank, {foreignKey:'creditId', onDelete:'CASCADE', as:'invoiceVendor'});

purchaseInvoice.hasMany(vendorLedger, {foreignKey:'debitId', onDelete:'CASCADE', as:'paymentVendor'});
vendorLedger.belongsTo(purchaseInvoice, {foreignKey:'debitId', onDelete:'CASCADE', as:'paymentVendor'});
