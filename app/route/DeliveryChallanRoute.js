...
const {
  ...
  create_deliverychallanitem,
  update_deliverychallan,
  update_deliverychallanitem,
...
router.post(
  "/create_deliverychallanitem",
  adminAuth("Delivery Challan:create_deliverychallanitem"),
  validation("create_deliverychallanitem"),
  create_deliverychallanitem
);
router.put(
...
router.put(
  "/update_deliverychallanitem/:id",
  adminAuth("Delivery Challan:update_deliverychallanitem"),
  update_deliverychallanitem
);
router.delete(
