...
exports.receiptdate = function (req, res, next) {
    ...
    const receiptdateSchema = Joi.string()
        ...
        .messages({
            ...
            "string.empty": "Receipt Date Cannot Be A Empty"
        });
...
exports.depositto = function (req, res, next) {
    ...
    const deposittoSchema = Joi.string()
        .required()
        .messages({
            "any.required": "Required Filed : Deposit To",
            "string.empty": "Deposit To Cannot Be A Empty"
        });
...
exports.amountrecive = function (req, res, next) {
    ...
    const amountreciveSchema = Joi.number()
        .required()
        .messages({
            "any.required": "Required filed : Amount Recive",
            "number.empty": "Amount Recive Cannot Be A Empty"
        });
